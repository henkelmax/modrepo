<template>
  <div>
    ...
    <br />
    <h2>Other people can't hear me</h2>
    <p>
    ...
    <p>
      If you are using MacOS, read
      <a href="?t=macos_microphone_permission">this</a>!
    </p>
    <p>
    ...
    <p>
      Another program is already using the voice chat port. Make sure you don't
