...
Additionally, there are many third party addons, which you can find [here](https://modrinth.com/collection/m4J6DQJK)
or in the `#voicechat-addon-showcase` channel on our [Discord server](https://discord.gg/4dH2zwTmyX).
