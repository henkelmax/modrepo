...
You can get a list of your backend servers by typing `/voicechatproxy ping`. Note that it's important that you provide the correct voice chat port of the backend server as the last argument, as the proxy itself is not aware of the voice chat port of the backend servers.
